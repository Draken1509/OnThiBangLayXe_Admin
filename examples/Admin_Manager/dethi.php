			...
			<div class="content">
				<div class="page-inner">
					<div class="page-header">
						<h4 class="page-title">DANH MỤC ĐỀ THI</h4>
							...
							<div class="card">
								<div class="card-header">
									<div class="d-flex align-items-center">
										<h4 class="card-title">Tạo đề mới</h4>
										<a href="taodethi.php"class="btn btn-primary btn-round ml-auto"> <i class="fa fa-plus"></i> Tạo đề thi mới</a>										
									</div>
								</div>
							</div>		
						</div>						
											...
											<tbody >
												...
												if($fetchdata>0)
												{
													foreach($fetchdata as $key=>$row)
													{
														...
														?>
										 			<tr>
															<td style="font-size:13px"><?php echo $row['MaDeThi']?></td>
															<td style="font-size:13px"><?php echo $row['MaLoaiBang']?></td>	
															<td style="font-size:13px"><?php echo "Đề thi số  ".$i?></td>																																																																																																							
														    <td>
															<div class="form-button-action" >															
																<a href="chitietdethi.php?id=<?php echo $row['MaDeThi'] ?>" class="btn btn-link btn-primary "  > Xem chi tiết</i></a>																																																				
															</div>
