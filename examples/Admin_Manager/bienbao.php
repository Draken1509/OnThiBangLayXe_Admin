			...
			<div class="content">
				<div class="page-inner">
					<div class="page-header">
						<h4 class="page-title">DANH MỤC BIỂN BÁO</h4>
											...
											<tbody >
												...
												if($fetchdata>0)
												{
													...
													{			
														?>
										 			<tr>
                                                        	<td><img width='50px' src= signs/<?php echo $row['HinhAnh'] ?>></td>	
															<td style="font-size:13px"><?php echo $row['MaBB']?></td>
															<td style="font-size:13px"><?php echo $row['MaLoaiBB']?></td>
															<td style="font-size:13px"><?php echo $row['NoiDung']?></td>
															<td style="font-size:13px"><?php echo $row['TieuDe']?></td>																													
