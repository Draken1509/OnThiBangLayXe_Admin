											...
											<tbody >
												...
												if($fetchdata>0)
												{
													foreach($fetchdata as $key=>$row)
													{
														...
														if($row['MaDeThi']==$madethi)	
														{	
															$i++;												
														?>
										 				<tr>
															<td><?=$i?></td>
															<td style="font-size:13px"><?php echo "Đề thi số " .$row['MaDeThi']?></td>
															...
															<button type="submit" data-toggle="tooltip" class="btn btn-link btn-danger"  data-original-title="Remove">																
